...
struct thread
  {
	...
	struct list_elem donateelem;		//min add, list element for donatelist
	struct lock* theLock;				//min add, pointer to the lock 
	...
	struct list_elem waitelem;			//min add, wait elem container for waitlist
